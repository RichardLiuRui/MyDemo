...
public class PictureSelector {
    ...
    public void selectPicture() {
        selectPicture(true, 200, 200, 1, 1,0);
    }
     ...
     */
    public void selectPicture(boolean cropEnabled, int cropWidth, int cropHeight, int ratioWidth, int ratioHeight, int selectType) {
        ...
        intent.putExtra(PictureSelectActivity.SELECT_TYPE, selectType);
        if (fragment != null) {
